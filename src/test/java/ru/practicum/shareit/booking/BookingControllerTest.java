...
class BookingControllerTest {
    ...
    void createAndReturnIncomingBookingDtoTest() throws Exception {
        ...
        when(bookingConverter.convertToIncomingDto(booking)).thenReturn(incomingBookingDto);
        ...
        mvc.perform(post("/bookings")
                ...
                .andExpect(jsonPath("$.id", is(incomingBookingDto.getId().intValue())))
                .andExpect(jsonPath("$.start", is(incomingBookingDto.getStart().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME))))
                .andExpect(jsonPath("$.itemId", is(incomingBookingDto.getItemId().intValue())));
    }
    ...
    void createBookingThrowsValidationExTest() throws Exception {
        ...
        when(bookingConverter.convertToIncomingDto(booking)).thenReturn(bookingDto);
